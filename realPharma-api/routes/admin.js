...
router.post("/addinventory", middleware.isAdmin, function(req, res){
  ...
  var companyname = req.body.medicinename.substr(0,req.body.medicinename.indexOf(' '));
    ...
    if(err){
      ...
      Manufacturer.find({name: companyname}, function(err, manufacturer){
        if(err){
          ...
          var newinventory = {medicinename: req.body.medicinename, manufacturer: manufacturerid, hexcode:hexcodearr, retailer: retailer_id };
